...
def __str__(self):
    return self.username, self.password, self.email, self.phone_number

class Formsubmited(models.Model):
    ...
    weightatBirth = models.DecimalField(max_digits=5, decimal_places=2, null = True)
...
class Documents(models.Model):
    applicant =  models.ForeignKey(Formsubmited, on_delete=models.CASCADE,  null = True, blank = True)
    title = models.CharField(max_length=150, null = True)
    local_council = models.FileField(upload_to ='documents/', null = True, blank = True)
    diso = models.FileField(upload_to ='documents/', null = True, blank = True)
